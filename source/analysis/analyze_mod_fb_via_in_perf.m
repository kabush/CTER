...
if(proj.flag.clean_build)
    disp(['Removing ',proj.path.analysis.mod_fb_via_in_perf]);
    eval(['! rm -rf ',proj.path.analysis.mod_fb_via_in_perf]);
    disp(['Creating ',proj.path.analysis.mod_fb_via_in_perf]);
    eval(['! mkdir ',proj.path.analysis.mod_fb_via_in_perf]);
end
